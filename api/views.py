...
#serializers
from .serializers import RegisterSerializer,UserSerializer,RefreshTokenSerializer,WriterSerializer,PublisherSerializer
...
class WriterListAPIView(ListAPIView):
    permission_classes = [AllowAny]
